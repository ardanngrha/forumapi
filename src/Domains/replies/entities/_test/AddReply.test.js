...
describe('a AddReply entities', () => {
  it('should throw error when owner is invalid', () => {
    ...
    expect(() => new AddReply(owner, commentId, payload)).toThrowError('ADD_REPLY.NOT_CONTAIN_NEEDED_PROPERTY');
  });
  ...
  it('should throw error when comment did not meet data type specification', () => {
    // Arrange
    const owner = 'user-123';
    const commentId = 123;
    const payload = {
